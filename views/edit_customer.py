...
class EditCustomer(ttk.Frame):
    ...
    def init_gui(self):
        self.root.title("Editar un cliente")     # Nombre de la ventana
        ...
        self.btn_update = ttk.Button(
            self.btns_frame, text='Actualizar', width=20, command=self.update_customer)
        # Reset
